...
const raisedToTheThird = (arr) => {
  let thirdPowArr = [];
  arr.forEach((element) => (thirdPowArr.push(Math.pow(element,3))));
  return thirdPowArr;
};
...
const addOne = (arr) => {
  let oneIncrArr = arr.map(element => element+1);
  return oneIncrArr;
};
...
const addQuestion = (arr) => {
  let stringQuestArr = arr.map(element => `${element}?`);
  return stringQuestArr;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i=0; i<arr.length; i++) {
    twoPowerOfArr.push(Math.pow(2,arr[i]));
  }
  return twoPowerOfArr;
};
...
const forEachTwoToThe = (arr) => {
  let twoPowerOfArr = [];
  arr.forEach(element => twoPowerOfArr.push(Math.pow(2,element)));
  return twoPowerOfArr;
};
...
const mapTwoToThe = (arr) => {
  let twoPowerOfArr = arr.map(element => Math.pow(2,element));
  return twoPowerOfArr;
};
